...
<div class="wrapper">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        ...
                        <!-- Message End -->Monthly Recap Report
                    </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Brian Vaartjes</a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">trainignen compleet</span>
                                <span class="info-box-number">73<small>%</small></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">trainignen gedaan</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">openstaande trainingen</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Totaal aantal medewerkers</span>
                                <span class="info-box-number">2.274</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Sessies Overzicht</h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <p class="text-center">
                                            <strong>Totaal aantal kennissessies en trainingen gedaan.</strong>
                                        </p>
                                    ...
                                    <div class="col-md-4">
                                        <p class="text-center">
                                            <strong>Overzicht totaal</strong>
                                        </p>
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="{{ url('/img/default-150x150.png') }}" alt="Product Image" class="img-size-50">
                                        </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020-2021 <a href="https://brianvaartjes.com/portfolio">Brian Vaartjes</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
