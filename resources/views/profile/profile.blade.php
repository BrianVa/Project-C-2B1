                                    ...
                                    <table id="" class="display SessionOverview">
                                        ...
                                        @foreach($sessionsdone as $session)
                                            ...
                                            <tr>
                                                ...
                                                <td><button @if($session->attended == 1) onclick="setsession('{{$session->firstname}}', '{{$session->lastname}}', '{{$session->begin_date}}', '{{$session->end_date}}', '{{$session->k_id}}')"  data-toggle="modal" data-target="#evaluation" @endif type="button"  class="@if($session->attended == 0) disabled @endif btn btn-info ">Evalueer</button></td>
                                            </tr>
                                        @endforeach
                                    </table>
                                </div>
